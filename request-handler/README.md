...
```bash
HalfJourney-sam$ sam logs -n StockCheckerFunction --stack-name HalfJourney-sam --tail
```
...
```bash
HalfJourney-sam$ cd functions/stock-checker
...
```bash
sam delete --stack-name HalfJourney-sam
```
