...
```bash
image-generator$ sam logs -n StockCheckerFunction --stack-name image-generator --tail
```
...
```bash
image-generator$ cd functions/stock-checker
...
```bash
sam delete --stack-name image-generator
```
